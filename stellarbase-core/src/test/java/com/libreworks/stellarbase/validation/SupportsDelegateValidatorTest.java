...
{
	/**
	 * Test method for {@link com.libreworks.stellarbase.validation.SupportsDelegateValidator#supports(java.lang.Class)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link com.libreworks.stellarbase.validation.SupportsDelegateValidator#validate(java.lang.Object, org.springframework.validation.Errors)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link com.libreworks.stellarbase.validation.SupportsDelegateValidator#toString()}.
	 */
	@Test
	public void testToString()
	{
		TestValidator validator = new TestValidator();
		SupportsDelegateValidator object = new SupportsDelegateValidator(validator, SimpleBean.class, Date.class);
		assertEquals(validator + " supporting class com.libreworks.stellarbase.test.SimpleBean, class java.util.Date", object.toString());
	}
