...
import com.libreworks.stellarbase.orm.context.InsertEvent;
import com.libreworks.stellarbase.orm.context.UpdateEvent;
import com.libreworks.stellarbase.orm.dao.WritableDao;
...
public abstract class AbstractWritableHibernateDao<T extends Modifiable<K>,K extends Serializable> extends AbstractHibernateDao<T,K> implements WritableDao<T,K>
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.libreworks.stellarbase.orm.dao.WritableDao#canUpdate()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.libreworks.stellarbase.orm.dao.WritableDao#create(java.util.Map, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.libreworks.stellarbase.orm.dao.WritableDao#update(com.libreworks.stellarbase.orm.model.Modifiable, java.util.Map, java.lang.String)
	 */
