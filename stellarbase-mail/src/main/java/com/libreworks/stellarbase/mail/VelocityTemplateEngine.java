...
public class VelocityTemplateEngine implements TemplateEngine, InitializingBean
{
	...
	/* (non-Javadoc)
	 * @see com.libreworks.stellarbase.mail.TemplateEngine#mergeIntoString(java.lang.String, java.util.Map)
	 */
	@Deprecated
	...
	/* (non-Javadoc)
	 * @see com.libreworks.stellarbase.mail.TemplateEngine#mergeIntoString(java.lang.String, java.util.Map, java.lang.String)
	 */
