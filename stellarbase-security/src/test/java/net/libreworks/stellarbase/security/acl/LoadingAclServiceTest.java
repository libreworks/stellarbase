...
public class LoadingAclServiceTest
{
	...
	/**
	 * Test method for {@link net.libreworks.stellarbase.security.acl.LoadingAclService#findChildren(org.springframework.security.acls.model.ObjectIdentity)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link net.libreworks.stellarbase.security.acl.LoadingAclService#loadAcl(org.springframework.security.acls.model.ObjectIdentity, java.util.List)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link net.libreworks.stellarbase.security.acl.LoadingAclService#readAclsById(java.util.List, java.util.List)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link net.libreworks.stellarbase.security.acl.LoadingAclService#setAclCache(net.libreworks.stellarbase.security.acl.AclCache)}.
	 */
	...
	/**
	 * Test method for {@link net.libreworks.stellarbase.security.acl.LoadingAclService#setLoaders(java.util.Collection)}.
	 */
	@Test(expected=IllegalArgumentException.class)
	...
	/**
	 * Test method for {@link net.libreworks.stellarbase.security.acl.LoadingAclService#setParentResolver(net.libreworks.stellarbase.security.acl.ParentObjectIdentityResolver)}.
	 */
	@Test(expected=IllegalArgumentException.class)
